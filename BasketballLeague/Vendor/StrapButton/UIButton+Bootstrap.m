...
-(void)dangerStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:210/255.0 green:48/255.0 blue:51/255.0 alpha:1];
    self.layer.borderColor = [[UIColor colorWithRed:212/255.0 green:63/255.0 blue:58/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:217/255.0 green:83/255.0 blue:79/255.0 alpha:1]] forState:UIControlStateHighlighted];
}

-(void)commitStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithHexString:@"#55585f"];
    self.layer.borderColor = [UIColor colorWithHexString:@"#55585f"].CGColor ;
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"#55585f"]] forState:UIControlStateNormal];
...
//    [self bootstrapStyle];
    ...
    [self setAdjustsImageWhenHighlighted:NO];
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    self.backgroundColor = [UIColor colorWithHexString:@"#27292e"];
//    self.layer.borderColor = [UIColor colorWithHexString:@"#27292e"].CGColor ;
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"#27292e"]] forState:UIControlStateNormal];
//    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"#fbb03b"]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"#fbb03b"]] forState:UIControlStateSelected];
}
